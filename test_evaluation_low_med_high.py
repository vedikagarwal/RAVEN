## Modified code to run directly on macbook gpu instead of cuda

# update the paths for checkpoint_dir, raven_base_dir, emb_path and output_csv
import os
import sys
import glob
import numpy as np
...
class RAVENDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # add the embeddign path here
        emb_path = "/Users/mani/CS7651_HML/Project/assets/embedding.npy"
        ...
        embeddings_dict = np.load(emb_path, allow_pickle=True, encoding='latin1').item()
    
        # Fill embedding tensor from structure
...
def main():
    ...
    # checkpoint and dataset path
    checkpoint_dir = '/Users/mani/CS7651_HML/Project/checkpoint'
    raven_base_dir = '/Users/mani/CS7651_HML/Project/Testing_Data/low'
    batch_size = 32
    img_size = 160
    output_csv = 'evaluation_results_low.csv'
    ...
    # no separate folder for each class
    dataset_dirs = [raven_base_dir]

    print(f"Using combined dataset: {raven_base_dir}")
    ...
    for dataset_dir in dataset_dirs:
        ...
        for ckpt_idx, ckpt_path in enumerate(checkpoint_files):
            ...
            try:
                ...
                accuracy = evaluate_checkpoint(model, testloader, device)
